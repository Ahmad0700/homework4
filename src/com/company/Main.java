...
public class Main {
    ...
    public static int[] heroesHealth = {260, 250, 270, 350, 100, 300, 400, 280};
    public static int[] heroesDamage = {15, 20, 10, 0, 10, 25, 5, 15};
    public static String[] heroesAttackType = {

            "Physical", "Magical", "Kinetic", "Medical", "Lucky", "Thor", "Golem", "Berserk"};
